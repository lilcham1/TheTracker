...
const ICON_PATHS = {
  ...
  meta:
    '<path d="M3 17.5 9 11l4 4 8-8.5"/><path d="M15.5 6.5H21v5.5"/>',
  settings:
    '<circle cx="12" cy="12" r="3"/><path d="M12 2.8v2.4M12 18.8v2.4M4.6 12H2.2M21.8 12h-2.4M6.4 6.4 4.7 4.7M19.3 19.3l-1.7-1.7M17.6 6.4l1.7-1.7M4.7 19.3l1.7-1.7"/>',
  builds:
